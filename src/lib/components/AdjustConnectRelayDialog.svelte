...
<Dialog.Root bind:open={relayDomainChangedDialogOpen}>
	<Dialog.Content>
		<Dialog.Header class="space-y-4">
			...
			<p>
				The ROOT Connect relay domain has been updated to match your selection for this product. Heads up: You won't be
				able to connect to products that use different relay domains.
			</p>
